...
if __name__=="__main__":
	...
	if mode.lower() == "server":
		coro = playground.getConnector('passthrough').create_playground_server(lambda: MyProtocolSever(), 101)
		...
		remoteAddress = mode
		#control = MyControl()
		coro = playground.getConnector('passthrough').create_playground_connection(lambda: MyProtocolClient(loop), remoteAddress, 101)
